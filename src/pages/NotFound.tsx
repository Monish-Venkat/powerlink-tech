  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-dark via-primary-dark/95 to-secondary/30 relative overflow-hidden">
      ...
      <div className="text-center relative z-10 px-4 max-w-lg">
        ...
        >
          <h1 className="font-display text-[150px] md:text-[200px] font-black text-accent-blue leading-none select-none">
            404
          </h1>
          <div className="absolute inset-0 flex items-center justify-center">
            <Zap className="w-16 h-16 md:w-24 md:h-24 text-accent-blue/30" />
          </div>
        </div>

        {/* Glass Card Content */}
        <div className="bg-white/10 border border-white/15 p-8 rounded-2xl backdrop-blur-sm">
          <h2 className="font-display text-2xl md:text-3xl font-bold text-primary-light mb-4">
            Oops! Power Outage
          </h2>
