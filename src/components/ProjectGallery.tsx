...
const ProjectGallery = ({ images, title }: ProjectGalleryProps) => {
  ...
  return (
    <>
      <div className="relative overflow-hidden rounded-t-2xl group/gallery bg-gradient-to-br from-gray-100 to-teal-50">
        {/* Image Carousel */}
        <div 
        ...
        <div className="absolute top-4 right-4 bg-gradient-to-r from-accent-blue to-cyan-600 text-white px-4 py-2 rounded-full text-sm font-bold shadow-lg flex items-center gap-2">
              ...
              <div className="absolute -bottom-24 left-1/2 transform -translate-x-1/2 flex gap-3 bg-black/40 backdrop-blur-md p-3 rounded-2xl">
                {images.map((img, idx) => (
                  <button
                    ...
                    aria-current={idx === modalImageIndex}
